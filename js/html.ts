...
export function novoItem(tag: string, conteudo: string) {
    /*
...
export function newTag(tag: string) {
    return $("<" + tag + "></" + tag + ">")
}

export function novaLista(titulo: string, itens: Array<string>,listaNumerada:boolean) {
  /*
    novoItem('h3', titulo)
...
export function novoLink(conteudo: string, url: string,link_externo:boolean) {
    /*
...
export function novoBotao(conteudo: string ) {
...
export function novoCampo(id: string, tipo: string,placeholder:string) {
...
export function alertar(conteudo: string) {
    $(function () {
        alert(conteudo);
    });
}
